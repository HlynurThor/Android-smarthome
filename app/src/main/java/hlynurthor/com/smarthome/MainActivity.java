...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SeekBar yourSeekBar=(SeekBar) findViewById(R.id.seekBar_Light1);
        ...
        buttonlightOn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (seekbar_Light.getProgress() == 0) {
                    ...
                    ObjectAnimator animation = ObjectAnimator.ofInt(seekbar_Light, "progress", 100);
                    ...
                    ObjectAnimator animation = ObjectAnimator.ofInt(seekbar_Light, "progress", 0);
                    animation.setDuration(1000);
                    animation.setInterpolator(new DecelerateInterpolator());
                    animation.start();
                }
